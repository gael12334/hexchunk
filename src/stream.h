...
typedef enum : uint64_t {
  ...
  sm_writeplus = ('+' << 8) | 'w',
  sm_appendplus = ('+' << 8) | 'a',
  sm_binary_read = ('b' << 8) | 'r',
  sm_binary_write = ('b' << 8) | 'w',
  sm_binary_append = ('b' << 8) | 'a',
  sm_binary_readplus = ('+' << 16) | ('b' << 8) | 'r',
  sm_binary_writeplus = ('+' << 16) | ('b' << 8) | 'w',
  sm_binary_appendplus = ('+' << 16) | ('b' << 8) | 'a',
  sm_plus = ('+' << 8),
  sm_binary = ('b' << 8),
  sm_binary_plus = ('+' << 16) | ('b' << 8),
} sm_t;
